...
type VoidFn = () => void;
type UnaryBoolFn = (value: any) => boolean;
type Reducer = (memo: any, value: any, key: number | string, collection: Collection) => any;

export type ICurry1<a, z> = (a: a) => z;
export interface ICurry2<a, b, z> {
  (a: a, b: b): z;
  (a: a): ICurry1<b, z>;
}

export interface ICurry3<a, b, c, z> {
  (a: a, b: b, c: c): z;
  (a: a, b: b): ICurry1<c, z>;
  (a: a): ICurry2<b, c, z>;
}

export interface ICurry4<a, b, c, d, z> {
  (a: a, b: b, c: c, d: d): z;
  (a: a, b: b, c: c): ICurry1<d, z>;
  (a: a, b: b): ICurry2<c, d, z>;
  (a: a): ICurry3<b, c, d, z>;
}

export interface ICurry5<a, b, c, d, e, z> {
  (a: a, b: b, c: c, d: d, e: e): z;
  (a: a, b: b, c: c, d: d): ICurry1<e, z>;
  (a: a, b: b, c: c): ICurry2<d, e, z>;
  (a: a, b: b): ICurry3<c, d, e, z>;
  (a: a): ICurry4<b, c, d, e, z>;
}

export interface ICurry {
  <a, z>(f: (a: a) => z, ctx?: any): ICurry1<a, z>;
  <a, b, z>(f: (a: a, b: b) => z, ctx?: any): ICurry2<a, b, z>;
  <a, b, c, z>(f: (a: a, b: b, c: c) => z, ctx?: any): ICurry3<a, b, c, z>;
  <a, b, c, d, z>(f: (a: a, b: b, c: c, d: d) => z, ctx?: any): ICurry4<a, b, c, d, z>;
  <a, b, c, d, e, z>(f: (a: a, b: b, c: c, d: d, e: e) => z, ctx?: any): ICurry5<a, b, c, d, e, z>;
}
